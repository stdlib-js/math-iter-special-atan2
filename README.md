...
```javascript
iterAtan2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-atan2@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-atan2@umd/bundle.js"></script>
```
